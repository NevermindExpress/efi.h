...
//System context for ARM64 processors
typedef struct {
...
typedef EFI_STATUS(EFIAPI *EFI_DEBUGPORT_WRITE) (
...
typedef EFI_STATUS(EFIAPI *EFI_DEBUGPORT_READ) (
	IN EFI_DEBUGPORT_PROTOCOL         *This,
	IN UINT32                         Timeout,
	IN OUT UINTN                      *BufferSize,
	OUT VOID                          *Buffer
...
typedef struct _EFI_DEBUG_IMAGE_INFO_TABLE_HEADER EFI_DEBUG_IMAGE_INFO_TABLE_HEADER; 

struct _EFI_DEBUG_IMAGE_INFO_TABLE_HEADER {
