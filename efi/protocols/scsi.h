...
typedef EFI_STATUS(EFIAPI *EFI_SCSI_IO_PROTOCOL_GET_DEVICE_TYPE) (
	IN EFI_SCSI_IO_PROTOCOL        *This,
	OUT UINT8                      *DeviceType
	);

typedef EFI_STATUS(EFIAPI *EFI_SCSI_IO_PROTOCOL_GET_DEVICE_LOCATION) (
	IN EFI_SCSI_IO_PROTOCOL                *This,
	IN OUT UINT8                           **Target,
	OUT UINT64                             *Lun
	);
...
typedef EFI_STATUS(EFIAPI *EFI_SCSI_IO_PROTOCOL_EXECUTE_SCSI_COMMAND) (
	IN EFI_SCSI_IO_PROTOCOL                  *This,
